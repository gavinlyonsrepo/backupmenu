...
Config file: The user may create the config file, if it does not exist, the program will create one with default values by downloading from github with curl.
"BM_DEST_PATH_X" is the path for backups.(where X is 1-6 )
"BM_RSYNC_SOURCE_PATH" and "BM_RSYNC_DEST_PATH" provide the source and destination paths for rsync option in backup menu.
...
10. Make tarball of Documents, Pictures, Videos, Music directories.
